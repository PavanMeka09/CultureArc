        ...
        <footer className="mt-20 py-8 border-t border-border-light dark:border-border-dark">
            <div className="flex flex-col sm:flex-row justify-between items-center gap-4 px-4">
                ...
                <div className="flex items-center gap-6">
                    <a className="text-sm text-slate-500 dark:text-slate-400 hover:text-primary dark:hover:text-accent transition-colors" href="mailto:tabletoplpu@gmail.com">Contact Us</a>
                </div>
            </div>
        </footer>
    );
